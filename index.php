  ...
  ?>
   ...
   ?>
        <tr>
            ...
            <td>
              <?php echo "<a href='index.php?action=update&id=".$value['id']."'>Edit</a>";?> ||<?php echo "<a href='index.php?action=delete&id=".$value['id']."' onclick='return confirm(\"Are you Sure to Delete Data...\")'>Delete</a>";?>
            </td>
        </tr>
   <?php } ?>
    </table>
